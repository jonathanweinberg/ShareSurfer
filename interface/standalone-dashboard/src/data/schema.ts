...
export const datasetLabels: Record<DatasetKey, string> = {
  ...
  ownership_enrichment: "Ownership enrichment",
  ownership_context: "Ownership context",
  ownership_relationships: "Ownership relationships",
  ownership_import_manifest: "Ownership import manifest",
  owner_risk_pivots: "Owner pivots",
  related_data_areas: "Migration clusters",
  owner_review_packets: "Review packets",
  owner_review_decisions: "Owner review decisions",
  migration_cluster_decisions: "Migration cluster decisions",
