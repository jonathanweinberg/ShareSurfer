...
Add-ShareSurferCloseoutLine -Lines $lines -Text ('- {0} Identity enrichment criteria prove employee identifiers, three-level manager chains when populated, and the selected OBS/OID attribute.' -f (Get-ShareSurferCloseoutStatus -Passed $identityDirectoryCriteriaPassed))
