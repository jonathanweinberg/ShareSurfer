...
Convert-ShareSurferArchivedCsvToSchema -Path (Join-Path $outputExportPath 'owner_review_decisions.csv') -Columns @(
    'DecisionId',
    'ReviewPacketId',
    'BusinessUnit',
    'Owner',
...
Convert-ShareSurferArchivedCsvToSchema -Path (Join-Path $outputExportPath 'migration_cluster_decisions.csv') -Columns @(
    'DecisionId',
    'RelatedAreaId',
    'RelatedDataArea',
    'BusinessUnit',
