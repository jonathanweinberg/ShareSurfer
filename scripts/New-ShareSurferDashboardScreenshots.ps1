...
function New-ShareSurferScreenshotDemoInventory {
    ...
    [pscustomobject]@{
        ...
        Items = @(
            [pscustomobject]@{ ItemId = 'item-fin-root'; ShareId = 'share-finance'; ItemType = 'Directory'; FullPath = '\\files01\Finance'; RelativePath = ''; Depth = 0; Owner = 'CONTOSO\FinanceOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = ''; InheritanceBreakType = 'None' },
            [pscustomobject]@{ ItemId = 'item-fin-ap'; ShareId = 'share-finance'; ItemType = 'Directory'; FullPath = '\\files01\Finance\AccountsPayable'; RelativePath = 'AccountsPayable'; Depth = 1; Owner = 'CONTOSO\FinanceOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = ''; InheritanceBreakType = 'None' },
            [pscustomobject]@{ ItemId = 'item-fin-vendors'; ShareId = 'share-finance'; ItemType = 'Directory'; FullPath = '\\files01\Finance\AccountsPayable\Vendors'; RelativePath = 'AccountsPayable\Vendors'; Depth = 2; Owner = 'CONTOSO\FinanceOwner'; InheritanceEnabled = $false; InheritanceBrokenAt = '\\files01\Finance\AccountsPayable\Vendors'; InheritanceBreakType = 'Direct' },
            [pscustomobject]@{ ItemId = 'item-fin-long'; ShareId = 'share-finance'; ItemType = 'Directory'; FullPath = $longPath; RelativePath = 'AccountsPayable\Vendors\' + $longTail; Depth = 5; Owner = 'CONTOSO\FinanceOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = '\\files01\Finance\AccountsPayable\Vendors'; InheritanceBreakType = 'InheritedAncestor' },
            [pscustomobject]@{ ItemId = 'item-fin-conflict'; ShareId = 'share-finance'; ItemType = 'Directory'; FullPath = '\\files01\Finance\AccountsPayable\ReaderModify'; RelativePath = 'AccountsPayable\ReaderModify'; Depth = 2; Owner = 'CONTOSO\FinanceOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = ''; InheritanceBreakType = 'None' },
            [pscustomobject]@{ ItemId = 'item-ops-root'; ShareId = 'share-operations'; ItemType = 'Directory'; FullPath = '\\files01\Operations'; RelativePath = ''; Depth = 0; Owner = 'CONTOSO\OperationsOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = ''; InheritanceBreakType = 'None' },
            [pscustomobject]@{ ItemId = 'item-ops-exec'; ShareId = 'share-operations'; ItemType = 'File'; FullPath = '\\files01\Operations\Restricted\FileOnly\executive-note.txt'; RelativePath = 'Restricted\FileOnly\executive-note.txt'; Depth = 3; Owner = 'CONTOSO\OperationsOwner'; InheritanceEnabled = $true; InheritanceBrokenAt = '\\files01\Operations\Restricted'; InheritanceBreakType = 'InheritedAncestor' }
        )
        SharePermissions = @(
            [pscustomobject]@{ ShareId = 'share-finance'; Identity = 'CONTOSO\SS-Finance-Readers'; Rights = 'Read'; AccessMask = ''; AccessControlType = 'Allow'; Source = 'Get-SmbShareAccess' },
            [pscustomobject]@{ ShareId = 'share-operations'; Identity = 'CONTOSO\SS-Operations-Owners'; Rights = 'Full'; AccessMask = ''; AccessControlType = 'Allow'; Source = 'Get-SmbShareAccess' }
        )
        AclEntries = @(
            [pscustomobject]@{ ItemId = 'item-fin-vendors'; ShareId = 'share-finance'; FullPath = '\\files01\Finance\AccountsPayable\Vendors'; Identity = 'CONTOSO\SS-Finance-Editors'; Rights = 'Modify'; AccessMask = ''; AccessControlType = 'Allow'; IsInherited = $false; InheritanceFlags = 'ContainerInherit,ObjectInherit'; PropagationFlags = 'None'; Depth = 2 },
            [pscustomobject]@{ ItemId = 'item-fin-long'; ShareId = 'share-finance'; FullPath = $longPath; Identity = 'CONTOSO\SS-Finance-Editors'; Rights = 'Modify'; AccessMask = ''; AccessControlType = 'Allow'; IsInherited = $false; InheritanceFlags = 'ContainerInherit,ObjectInherit'; PropagationFlags = 'None'; Depth = 5 },
            [pscustomobject]@{ ItemId = 'item-fin-conflict'; ShareId = 'share-finance'; FullPath = '\\files01\Finance\AccountsPayable\ReaderModify'; Identity = 'CONTOSO\SS-Finance-Readers'; Rights = 'Modify'; AccessMask = ''; AccessControlType = 'Allow'; IsInherited = $false; InheritanceFlags = 'ContainerInherit,ObjectInherit'; PropagationFlags = 'None'; Depth = 2 },
            [pscustomobject]@{ ItemId = 'item-fin-conflict'; ShareId = 'share-finance'; FullPath = '\\files01\Finance\AccountsPayable\ReaderModify'; Identity = 'CONTOSO\SS-Finance-Readers'; Rights = 'Read'; AccessMask = ''; AccessControlType = 'Deny'; IsInherited = $false; InheritanceFlags = 'ContainerInherit,ObjectInherit'; PropagationFlags = 'None'; Depth = 2 },
            [pscustomobject]@{ ItemId = 'item-ops-exec'; ShareId = 'share-operations'; FullPath = '\\files01\Operations\Restricted\FileOnly\executive-note.txt'; Identity = 'CONTOSO\SS-Operations-Owners'; Rights = 'Read'; AccessMask = ''; AccessControlType = 'Allow'; IsInherited = $false; InheritanceFlags = 'None'; PropagationFlags = 'None'; Depth = 3 }
        )
        Identities = @()
        GroupEdges = @()
        OrgChains = @()
