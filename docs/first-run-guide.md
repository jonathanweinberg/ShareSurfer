...
| `shares.csv` | Which shares were scanned and whether data was partial. |
...
| --- | --- |
| The scan shows partial data | Confirm your account can read share metadata, folders, files, and ACLs. |
