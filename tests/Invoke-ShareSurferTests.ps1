...
$tests = @(
    ...
    @{
        ...
        Body = {
            ...
            Assert-True ($readmeText -like '*v0.1.0-pre.10*') 'README should reference the current pre-release quickstart package.'
            Assert-True ($readmeText -like '*ShareSurfer-0.1.0-pre.10.zip*') 'README should name the current pre-release zip asset.'
            ...
            Assert-True ($firstRunText -like '*v0.1.0-pre.10 release package*') 'First-run guide should reference the current pre-release dashboard package.'
            ...
            Assert-True ($nonpermissiveText -like '*ShareSurfer-0.1.0-pre.10.zip*') 'Nonpermissive workflow should name the current pre-release zip asset.'
